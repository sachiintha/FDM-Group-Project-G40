...
background-image: url("https://www.simplilearn.com/ice9/free_resources_article_thumb/What_is_Data_Analysis.jpg");
...
def main():
    ...
    add_selectbox = st.sidebar.selectbox(
        "How would you wish to be predicted?", ("Online", "Batch"))
    ...
    if add_selectbox == "Online":
        ...
        if st.button('Predict'):
            if prediction == 1:
                st.warning('Yes, the customer will leave the company.')
            else:
                st.success('No, the customer will stay with the comapny.')
